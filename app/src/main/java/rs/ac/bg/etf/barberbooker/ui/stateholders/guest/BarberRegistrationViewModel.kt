...
data class BarberRegistrationUiState(
    ...
    var price: String = "",
    var isMondayChecked: Boolean = true,
    var isTuesdayChecked: Boolean = true,
    var isWednesdayChecked: Boolean = true,
    var isThursdayChecked: Boolean = true,
    var isFridayChecked: Boolean = true,
...
class BarberRegistrationViewModel @Inject constructor(
    ...
    fun addNewBarber() = viewModelScope.launch {
